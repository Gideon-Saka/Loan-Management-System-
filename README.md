...
# Project Overview
Financial institutions often manage loan applications and repayments using fragmented processes involving spreadsheets, emails, and manual verification. This leads to delays in approvals, lack of transparency for customers, difficulty tracking repayments, and limited managerial oversight. The goal of this project was to analyse and design a centralized Loan Management System that digitizes the full loan lifecycle — from application submission to loan closure.

# Business Problem
Customers experienced uncertainty about application status and payment schedules, while staff struggled with repetitive manual checks and inconsistent record keeping. Managers also lacked real-time visibility into loan performance and overdue accounts. These inefficiencies increased operational risk and reduced customer satisfaction.
...
# Tools & Techniques
BPMN 2.0 | Requirements Analysis | Use Case Modelling | Process Mapping | Stakeholder Analysis
